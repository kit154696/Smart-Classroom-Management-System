...
async function setupDB() {
  ...
  await c.query('DROP VIEW IF EXISTS AttendanceAnalysis');
  ...
  await c.query("CREATE TABLE Submission(submission_id INT AUTO_INCREMENT,assignment_id INT NOT NULL,student_id VARCHAR(20) NOT NULL,score DECIMAL(5,2),submit_date DATETIME DEFAULT CURRENT_TIMESTAMP,graded_date DATETIME,graded_by VARCHAR(20),status ENUM('submitted','graded','late') DEFAULT 'submitted',PRIMARY KEY(submission_id),UNIQUE KEY uq(assignment_id,student_id),FOREIGN KEY(assignment_id) REFERENCES Assignment(assignment_id) ON DELETE CASCADE,FOREIGN KEY(student_id) REFERENCES Student(student_id) ON DELETE CASCADE,FOREIGN KEY(graded_by) REFERENCES Teacher(teacher_id))");
  ...
  await c.query("INSERT INTO Attendance(student_id,schedule_id,attendance_date,check_in_time,status) VALUES('683380495-2',1,'2026-02-02','10:03','present'),('683380495-2',1,'2026-02-09','10:18','late'),('683380495-2',1,'2026-02-16','10:05','present'),('683380495-2',1,'2026-02-23',NULL,'absent'),('683380495-2',3,'2026-02-03','09:02','present'),('683380495-2',5,'2026-02-03','13:05','present'),('683380495-2',9,'2026-02-04','13:10','present'),('683380495-2',11,'2026-02-06','13:05','present'),('683380495-3',1,'2026-02-02','10:05','present'),('683380495-3',1,'2026-02-09','10:25','late'),('683380495-3',1,'2026-02-16',NULL,'absent'),('683380495-3',5,'2026-02-03','13:02','present'),('683380495-4',3,'2026-02-03','09:05','present'),('683380495-4',3,'2026-02-10','09:22','late'),('683380495-4',9,'2026-02-04',NULL,'absent'),('683380495-4',9,'2026-02-11','13:05','present'),('683380495-5',1,'2026-02-02',NULL,'absent'),('683380495-5',1,'2026-02-09',NULL,'absent'),('683380495-5',10,'2026-02-05','10:01','present'),('683380495-5',10,'2026-02-12',NULL,'absent'),('683380495-6',7,'2026-02-03','16:00','present'),('683380495-6',7,'2026-02-10','16:20','late'),('683380495-6',11,'2026-02-06','13:04','present'),('683380495-6',11,'2026-02-13','13:25','late'),('683380495-7',5,'2026-02-03','13:03','present'),('683380495-7',5,'2026-02-10','13:18','late'),('683380495-7',4,'2026-02-05','09:00','present'),('683380495-7',4,'2026-02-12',NULL,'absent')");
  await c.query("INSERT INTO AttendanceAnalysis(student_id,course_id,total_classes,absent_count,late_count,attendance_rate,risk_level) VALUES('683380495-2','SC602005',4,1,1,75.00,'Medium'),('683380495-2','LI101001',1,0,0,100.00,'Low'),('683380495-2','CP411106',1,0,0,100.00,'Low'),('683380495-2','CP411105',1,0,0,100.00,'Low'),('683380495-2','CP411701',1,0,0,100.00,'Low'),('683380495-2','GE341511',1,0,0,100.00,'Low'),('683380495-3','SC602005',3,1,1,66.67,'High'),('683380495-3','CP411106',1,0,0,100.00,'Low'),('683380495-4','LI101001',2,0,1,100.00,'Low'),('683380495-4','CP411105',2,1,0,50.00,'High'),('683380495-5','SC602005',2,2,0,0.00,'High'),('683380495-5','CP411701',2,1,0,50.00,'High'),('683380495-6','SC401201',2,0,1,100.00,'Low'),('683380495-6','GE341511',2,0,1,100.00,'Low'),('683380495-7','CP411106',2,0,1,100.00,'Low'),('683380495-7','LI101001',2,1,0,50.00,'High')");
  await c.query("INSERT INTO Grade(student_id,course_id,attend_score,attitude_score,homework_score,midterm_score,final_score,quiz_score,total_score,grade_letter) VALUES('683380495-2','SC602005',18,9,17,26,34,16,120,'A'),('683380495-2','LI101001',19,9,18,27,35,17,125,'A'),('683380495-2','CP411106',20,10,19,28,37,18,132,'A'),('683380495-2','SC401201',17,8,16,24,32,15,112,'B+'),('683380495-2','CP411105',18,9,17,25,33,16,118,'A'),('683380495-2','CP411701',15,7,14,20,28,13,97,'B'),('683380495-2','GE341511',16,8,15,22,30,14,105,'B+'),('683380495-3','SC602005',15,7,14,20,28,12,96,'B'),('683380495-3','CP411106',16,8,15,22,30,13,104,'B+'),('683380495-4','SC602005',20,10,20,29,38,19,136,'A'),('683380495-4','CP411106',20,10,20,30,39,19,138,'A'),('683380495-5','SC602005',10,5,9,14,19,8,65,'C'),('683380495-5','CP411106',12,6,11,16,21,9,75,'B+'),('683380495-6','SC602005',17,8,16,24,32,15,112,'B+'),('683380495-6','CP411106',17,8,16,24,32,15,112,'B+'),('683380495-7','SC602005',19,10,18,27,36,17,127,'A'),('683380495-7','CP411106',18,9,17,26,34,16,120,'A')");
  await c.query("INSERT INTO Assignment(course_id,title,due_date,max_score) VALUES('SC602005','Quiz: Probability','2026-03-10 23:59',20),('SC602005','Project: Statistics','2026-04-10 23:59',30),('LI101001','Essay: Hometown','2026-03-20 23:59',20),('CP411106','Lab: Data Preprocessing','2026-03-25 23:59',20),('CP411106','Project: ML','2026-04-20 23:59',40),('SC401201','Homework: Derivatives','2026-04-01 23:59',20),('CP411105','Lab: CPU Scheduling','2026-03-28 23:59',25),('CP411701','Essay: AI','2026-03-18 23:59',25),('GE341511','Quiz: Stats','2026-03-22 23:59',20)");
  await c.query("INSERT INTO Submission(assignment_id,student_id,score,submit_date,graded_date,graded_by,status) VALUES(1,'683380495-2',18,'2026-03-09 20:00','2026-03-11 10:00','TCH001','graded'),(3,'683380495-2',17.5,'2026-03-19 22:00','2026-03-21 09:00','TCH002','graded'),(4,'683380495-2',19,'2026-03-24 21:00','2026-03-26 10:00','TCH001','graded'),(7,'683380495-2',22,'2026-03-27 23:00','2026-03-29 10:00','TCH001','graded'),(8,'683380495-2',23,'2026-03-17 21:00','2026-03-19 09:00','TCH002','graded'),(1,'683380495-3',14,'2026-03-10 10:00','2026-03-11 11:00','TCH001','graded'),(1,'683380495-4',20,'2026-03-08 18:00','2026-03-10 09:00','TCH001','graded'),(1,'683380495-5',10,'2026-03-12 23:50',NULL,NULL,'late'),(4,'683380495-6',17,'2026-03-24 20:00','2026-03-26 10:00','TCH001','graded'),(3,'683380495-7',19.5,'2026-03-19 18:00','2026-03-21 10:00','TCH002','graded')");
  c.release();
}
...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    if (p==='/api/submissions') return json(res,200,{success:true,data:await query("SELECT sb.*,a.title AS assignment_title,s.name AS student_name,c.course_name,t.name AS graded_by_name FROM Submission sb JOIN Assignment a ON sb.assignment_id=a.assignment_id JOIN Student s ON sb.student_id=s.student_id JOIN Course c ON a.course_id=c.course_id LEFT JOIN Teacher t ON sb.graded_by=t.teacher_id ORDER BY sb.graded_by='TCH002' DESC, sb.graded_by DESC, sb.submit_date DESC")});
    ...
    if (p==='/api/analysis')    return json(res,200,{success:true,data:await query("SELECT aa.*,s.name AS student_name,c.course_name FROM AttendanceAnalysis aa JOIN Student s ON aa.student_id=s.student_id JOIN Course c ON aa.course_id=c.course_id ORDER BY FIELD(aa.risk_level,'High','Medium','Low'),aa.attendance_rate ASC")});
